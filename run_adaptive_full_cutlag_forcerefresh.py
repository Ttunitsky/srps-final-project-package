...
def run_instance(args) -> dict:
    ...
    if ub is not None and (ub - best_obj) < 0.9999:
        ...
        while True:
            ...
            new_ub = ub
            ub_tightened = False
            # DIAGNOSTIC ONLY: force UB refresh even after objective improvement.
            # This checks that lag/cutlag refresh works inside the full ALNS pipeline.
            if ub is not None and stop_reason != "UB" and not no_refresh:
                if bound_mode == "lag":
