...
certified bound against a matched-budget plain Lagrangian baseline, winning on
...
for the plain Lagrangian arm, with 12 instance wins to 8. This is the one
dual-side technique in the study that demonstrably tightens the bound, and its
...
that demonstrably tightens the bound. Sections~\ref{sec:dual}--\ref{sec:runtime} are organised
...
The cut-augmented Lagrangian demonstrably tightens the bound in standalone
comparison.  With the same dual budget, cutLR-triple reduces mean certified gap
...
contribution: a cut-augmented Lagrangian relaxation that demonstrably tightens
...
instances in standalone comparison ($0.361\%$ mean versus $0.455\%$ for matched-budget
plain LR, $-0.094\pp$).  In a pipeline experiment with deliberately weakened
initial bounds the cut-augmented arm wins 12 of 54 instance comparisons against
8 for plain LR, with advantage concentrated on medium-hard instances.  The
